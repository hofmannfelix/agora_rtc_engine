...
class _MyAppState extends State<MyApp> {
        ...
        body: Container(
          child: Column(
            children: [
              ...
              OutlineButton(
                child: Text(_isInChannel ? 'Leave Channel' : 'Join Channel', style: textStyle),
  ...
  Future<void> _initAgoraRtcEngine() async {
    AgoraRtcEngine.create('8c2bbbb017754a5f8c4aa24fb2d5bf34');
  ...
  void _addAgoraEventHandlers() {
    ...
    AgoraRtcEngine.onRemoteVideoStateChanged =
        (a, b, c, d) => setState(() => print("FCUK YU"));

    AgoraRtcEngine.onRemoteVideoStats =
        (stats) => setState(() => print(stats.toJson()));
  }
  ...
  void _toggleChannel() {
    setState(() async {
      if (_isInChannel) {
        ...
        await AgoraRtcEngine.joinChannel(null, '51n316sC-3TTU-224S-2286-jf102Mw21231', null, 4);
      }
    });
  }
